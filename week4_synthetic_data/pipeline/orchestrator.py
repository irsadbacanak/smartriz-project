...
from week4_synthetic_data.config import (
    BASE_URL,
    DATA_DIR,
    DEEPINFRA_API_KEY,
    JUDGE_THRESHOLD,
...
from week4_synthetic_data.pipeline.teacher import TeacherClient
from week4_synthetic_data.pipeline.judge import JudgeClient
from week4_synthetic_data.quality.matrix import check, parse_param_id, parse_principle_id
...
async def _run_teacher_task(
    ...
    from week4_synthetic_data.prompts.self_instruct import build_prompt as si_prompt
    from week4_synthetic_data.prompts.evol_deepening import build_prompt as deep_prompt
    from week4_synthetic_data.prompts.evol_constraint import build_prompt as const_prompt
    from week4_synthetic_data.prompts.evol_cross_domain import build_prompt as xdom_prompt
