...
Usage:
  ...
  python -m week4_synthetic_data.main --smoke --n 5

  # Full single round
  python -m week4_synthetic_data.main --round 1 --temperature 0.7

  # Multi-round until ≥10K
  python -m week4_synthetic_data.main --auto --target 10000
"""
...
async def _run(args: argparse.Namespace) -> None:
    from week4_synthetic_data.pipeline.orchestrator import run_round
    from week4_synthetic_data.quality.deduplicator import deduplicate
    from week4_synthetic_data.quality.validator import validate_and_assemble, count_final_cases
    from week4_synthetic_data.config import TEMPERATURES
